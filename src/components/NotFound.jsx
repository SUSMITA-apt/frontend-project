            ...
            <section>
                <div className="container">
                    <div className="main">
                        ...
                        <div className="pb-39 flex flex-col justify-center items-center px-4 text-center">
                            <h2 className="text-[80px] md:text-[110px] leading-tight font-medium font-inter">404 Not Found</h2>
